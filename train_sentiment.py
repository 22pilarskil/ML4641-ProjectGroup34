...
with open(results_file, 'a+', newline='') as file:
    ...
    writer.writerow(["epoch", "train_loss", "train_accuracy", "train_f1", "test_loss", "test_accuracy", "test_f1"])
...
for epoch in range(epochs):
    ...
    model.eval()
    train_loss, train_accuracy, train_f1 = evaluate_model(model, train_loader, loss_fn, device)
    test_loss, test_accuracy, test_f1 = evaluate_model(model, test_loader, loss_fn, device)
